# This program is our first attempt at feature extraction.
# We save every feature from every <--frame_skip> frames in the scan video.
# Then we perform matching between features from that frame and every 
# <--feature_frames> ahead and behind it. If that same feature is seen
# in any of those neighboring frames, it is considered good, and saved
# for the brute force matching stage. 
import json
import cv2 as cv
import numpy as np
